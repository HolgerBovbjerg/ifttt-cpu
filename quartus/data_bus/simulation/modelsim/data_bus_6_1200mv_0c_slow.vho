...
ENTITY 	data_bus IS
	...
	o_B0 : BUFFER std_logic_vector(7 DOWNTO 0);
	o_B1 : BUFFER std_logic_vector(7 DOWNTO 0)
	);
END data_bus;
...
-- i_Select[0]	=>  Location: PIN_K2,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- i_Select[1]	=>  Location: PIN_E2,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL \i_Select[1]~inputclkctrl_INCLK_bus\ : std_logic_vector(3 DOWNTO 0);
...
SIGNAL \i_Select[1]~inputclkctrl_outclk\ : std_logic;
...
\i_Select[1]~inputclkctrl_INCLK_bus\ <= (vcc & vcc & vcc & \i_Select[1]~input_o\);
...
-- Equation(s):
-- \Mux9~0_combout\ = (\i_Select[0]~input_o\ & (\i_A1[0]~input_o\)) # (!\i_Select[0]~input_o\ & ((\i_A0[0]~input_o\)))
...
-- Location: CLKCTRL_G4
\i_Select[1]~inputclkctrl\ : cycloneiii_clkctrl
-- pragma translate_off
GENERIC MAP (
...
-- pragma translate_on
PORT MAP (
	inclk => \i_Select[1]~inputclkctrl_INCLK_bus\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	outclk => \i_Select[1]~inputclkctrl_outclk\);

-- Location: LCCOMB_X17_Y1_N18
\o_B0[0]$latch\ : cycloneiii_lcell_comb
-- Equation(s):
-- \o_B0[0]$latch~combout\ = (GLOBAL(\i_Select[1]~inputclkctrl_outclk\) & (\o_B0[0]$latch~combout\)) # (!GLOBAL(\i_Select[1]~inputclkctrl_outclk\) & ((\Mux9~0_combout\)))
...
PORT MAP (
	...
	datad => \i_Select[1]~inputclkctrl_outclk\,
...
-- Equation(s):
-- \Mux10~0_combout\ = (\i_Select[0]~input_o\ & (\i_A1[1]~input_o\)) # (!\i_Select[0]~input_o\ & ((\i_A0[1]~input_o\)))
...
-- Equation(s):
-- \o_B0[1]$latch~combout\ = (GLOBAL(\i_Select[1]~inputclkctrl_outclk\) & ((\o_B0[1]$latch~combout\))) # (!GLOBAL(\i_Select[1]~inputclkctrl_outclk\) & (\Mux10~0_combout\))
...
PORT MAP (
	...
	datac => \i_Select[1]~inputclkctrl_outclk\,
...
-- Equation(s):
-- \Mux11~0_combout\ = (\i_Select[0]~input_o\ & (\i_A1[2]~input_o\)) # (!\i_Select[0]~input_o\ & ((\i_A0[2]~input_o\)))
...
-- Equation(s):
-- \o_B0[2]$latch~combout\ = (GLOBAL(\i_Select[1]~inputclkctrl_outclk\) & ((\o_B0[2]$latch~combout\))) # (!GLOBAL(\i_Select[1]~inputclkctrl_outclk\) & (\Mux11~0_combout\))
...
-- Equation(s):
-- \Mux12~0_combout\ = (\i_Select[0]~input_o\ & ((\i_A1[3]~input_o\))) # (!\i_Select[0]~input_o\ & (\i_A0[3]~input_o\))
...
PORT MAP (
	...
	datad => \i_Select[0]~input_o\,
	combout => \Mux12~0_combout\);

-- Location: LCCOMB_X17_Y1_N24
\o_B0[3]$latch\ : cycloneiii_lcell_comb
-- Equation(s):
-- \o_B0[3]$latch~combout\ = (GLOBAL(\i_Select[1]~inputclkctrl_outclk\) & ((\o_B0[3]$latch~combout\))) # (!GLOBAL(\i_Select[1]~inputclkctrl_outclk\) & (\Mux12~0_combout\))
...
-- Equation(s):
-- \Mux13~0_combout\ = (\i_Select[0]~input_o\ & ((\i_A1[4]~input_o\))) # (!\i_Select[0]~input_o\ & (\i_A0[4]~input_o\))
...
-- Equation(s):
-- \o_B0[4]$latch~combout\ = (GLOBAL(\i_Select[1]~inputclkctrl_outclk\) & (\o_B0[4]$latch~combout\)) # (!GLOBAL(\i_Select[1]~inputclkctrl_outclk\) & ((\Mux13~0_combout\)))
...
-- Equation(s):
-- \Mux14~0_combout\ = (\i_Select[0]~input_o\ & (\i_A1[5]~input_o\)) # (!\i_Select[0]~input_o\ & ((\i_A0[5]~input_o\)))
...
-- Equation(s):
-- \o_B0[5]$latch~combout\ = (GLOBAL(\i_Select[1]~inputclkctrl_outclk\) & ((\o_B0[5]$latch~combout\))) # (!GLOBAL(\i_Select[1]~inputclkctrl_outclk\) & (\Mux14~0_combout\))
...
-- Equation(s):
-- \Mux15~0_combout\ = (\i_Select[0]~input_o\ & ((\i_A1[6]~input_o\))) # (!\i_Select[0]~input_o\ & (\i_A0[6]~input_o\))
...
-- Equation(s):
-- \o_B0[6]$latch~combout\ = (GLOBAL(\i_Select[1]~inputclkctrl_outclk\) & ((\o_B0[6]$latch~combout\))) # (!GLOBAL(\i_Select[1]~inputclkctrl_outclk\) & (\Mux15~0_combout\))
...
-- Equation(s):
-- \Mux16~0_combout\ = (\i_Select[0]~input_o\ & ((\i_A1[7]~input_o\))) # (!\i_Select[0]~input_o\ & (\i_A0[7]~input_o\))
...
-- Equation(s):
-- \o_B0[7]$latch~combout\ = (GLOBAL(\i_Select[1]~inputclkctrl_outclk\) & ((\o_B0[7]$latch~combout\))) # (!GLOBAL(\i_Select[1]~inputclkctrl_outclk\) & (\Mux16~0_combout\))
...
-- Equation(s):
-- \o_B1[0]$latch~combout\ = (GLOBAL(\i_Select[1]~inputclkctrl_outclk\) & ((\Mux9~0_combout\))) # (!GLOBAL(\i_Select[1]~inputclkctrl_outclk\) & (\o_B1[0]$latch~combout\))
...
-- Equation(s):
-- \o_B1[1]$latch~combout\ = (GLOBAL(\i_Select[1]~inputclkctrl_outclk\) & (\Mux10~0_combout\)) # (!GLOBAL(\i_Select[1]~inputclkctrl_outclk\) & ((\o_B1[1]$latch~combout\)))
...
-- Equation(s):
-- \o_B1[2]$latch~combout\ = (GLOBAL(\i_Select[1]~inputclkctrl_outclk\) & ((\Mux11~0_combout\))) # (!GLOBAL(\i_Select[1]~inputclkctrl_outclk\) & (\o_B1[2]$latch~combout\))
...
-- Equation(s):
-- \o_B1[3]$latch~combout\ = (GLOBAL(\i_Select[1]~inputclkctrl_outclk\) & (\Mux12~0_combout\)) # (!GLOBAL(\i_Select[1]~inputclkctrl_outclk\) & ((\o_B1[3]$latch~combout\)))
...
-- Equation(s):
-- \o_B1[4]$latch~combout\ = (GLOBAL(\i_Select[1]~inputclkctrl_outclk\) & (\Mux13~0_combout\)) # (!GLOBAL(\i_Select[1]~inputclkctrl_outclk\) & ((\o_B1[4]$latch~combout\)))
...
-- Equation(s):
-- \o_B1[5]$latch~combout\ = (GLOBAL(\i_Select[1]~inputclkctrl_outclk\) & (\Mux14~0_combout\)) # (!GLOBAL(\i_Select[1]~inputclkctrl_outclk\) & ((\o_B1[5]$latch~combout\)))
...
-- Equation(s):
-- \o_B1[6]$latch~combout\ = (GLOBAL(\i_Select[1]~inputclkctrl_outclk\) & (\Mux15~0_combout\)) # (!GLOBAL(\i_Select[1]~inputclkctrl_outclk\) & ((\o_B1[6]$latch~combout\)))
...
-- Equation(s):
-- \o_B1[7]$latch~combout\ = (GLOBAL(\i_Select[1]~inputclkctrl_outclk\) & (\Mux16~0_combout\)) # (!GLOBAL(\i_Select[1]~inputclkctrl_outclk\) & ((\o_B1[7]$latch~combout\)))
